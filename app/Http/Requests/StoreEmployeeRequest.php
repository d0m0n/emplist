...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'residence_status' => 'nullable|required_unless:nationality,日本|string|max:100',
            'residence_card_expiry' => 'nullable|required_unless:nationality,日本|date|after:today',
    ...
    public function messages(): array
    {
        return [
            ...
            'residence_status.required_unless' => '外国籍の場合、在留資格は必須です。',
            'residence_card_expiry.required_unless' => '外国籍の場合、在留カード有効期限は必須です。',
